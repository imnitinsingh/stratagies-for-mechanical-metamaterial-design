...
def visualize(position_vector, n, shape_info_bodies):
    ...
    for i in range(0, n**2-1):
        ...
        pylab.gca().add_patch(patches.Polygon(corner_body,closed=True,fill=True, color = '#2E348E', alpha = 1,lw=1)) 
        ...
        #if(i==5 or i==7):
        plt.plot(corner_body[:,0], corner_body[:,1], 'o', color = 'white', markeredgecolor='black', markersize = 2) 
