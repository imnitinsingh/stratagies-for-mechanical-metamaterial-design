...
from math import atan2;  from Helper_Files.result_section_perfect_loops_hlpr2 import visualize 
# ----------------------------------------------------------------------------------------------------------------------
...
def hlpr_fun(pts, theta):
    ...
    for PositionVector[5] in theta:
        ...
        pos_vec_deformed = visualize(PositionVector, n, ShapeInfo, '#3A528B')
        
     
    
    
    return (pos_vec_deformed)
